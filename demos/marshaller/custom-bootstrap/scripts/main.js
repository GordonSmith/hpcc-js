...
(function (root, factory) {
    ...
    var ddlUrl = "http://10.241.100.157:8010/WsWorkunits/WUResult.json?Wuid=W20170209-151711&ResultName=suspectaddresssearchv2_Comp_Ins92117_DDL";
    var marshaller = null;
    var stack = [];
    var stackFinger = -1;
    ...
    function populateContent() {
        ...
        marshaller
            .render(function () {
                ...
                ;
                /*
                marshaller.primeData({ "suspectaddresssearchv2FORM": { "providerkey": "PDI522049" } }).then(function () {
                    dashboardMarshaller.renderContent();
                });
                */
