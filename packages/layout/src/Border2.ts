...
export class Border2 extends HTMLWidget {
    ...
    private _top: WidgetDiv;
    private _left: WidgetDiv;
    private _center: WidgetDiv;
    private _right: WidgetDiv;
    private _bottom: WidgetDiv;
    ...
    enter(domNode, element) {
        ...
        this._top = new WidgetDiv(element.append("header"));
        const body = element.append("div").attr("class", "body");
        this._center = new WidgetDiv(body.append("center"));
        this._left = new WidgetDiv(body.append("lhs"));
        this._right = new WidgetDiv(body.append("rhs"));
        this._bottom = new WidgetDiv(element.append("footer"));
    }

    update(domNode, element) {
        super.update(domNode, element);
        const topBBox: BBox = this._top.widget(this.top()).render(true) as BBox;
        const leftBBox: BBox = this._left.widget(this.left()).render(true) as BBox;
        const rightBBox: BBox = this._right.widget(this.right()).render(true) as BBox;
        const bottomBBox: BBox = this._bottom.widget(this.bottom()).render(true) as BBox;
