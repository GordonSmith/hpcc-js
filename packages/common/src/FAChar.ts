...
export class FAChar extends SVGWidget {
    ...
    calcChar(): string {
        const retVal = this.char();
        if (retVal.indexOf("fa-") === 0) {
            return String.fromCharCode(FACharMapping[retVal]);
        }
        return retVal;
    }
...
FAChar.prototype.publish("char", "", "set", "Font Awesome Item", Object.keys(FACharMapping), { tags: ["Private"] });
