...
function cdnPath(url: string, min: boolean = true, additionalPaths: { [key: string]: string } = {}): Promise<any> {
    ...
    return new Promise((resolve, reject) => {
        function reqListener() {
            ...
            console.log(`Located CDN @hpcc-js version:  ${pkg.version}`);
            window.__hpcc_topoJsonFolder = `${url}/map/TopoJSON`;
            const paths: { [key: string]: string } = {
                "@hpcc-js/map/TopoJSON": `${url}/map/TopoJSON`,
                ...additionalPaths
...
function unpkgPath(url: string, min: boolean = true, additionalPaths: { [key: string]: string } = {}): Promise<any> {
    ...
    return new Promise((resolve, reject) => {
        function reqListener() {
            const pkg = JSON.parse(this.responseText);
            console.log(`Located @hpcc-js version:  ${pkg.version}`);
...
// altUrl candidates  ---
// https://unpkg.com/@hpcc-js/loader
// https://unpkg.com/@hpcc-js/loader/dist/index.min.js
// https://unpkg.com/@hpcc-js/loader@^2.1.0
// https://unpkg.com/@hpcc-js/loader@2.1.0/dist/index.min.js
// https://viz.hpcc-systems/v2.2.6
// https://viz.hpcc-systems/v2.2.6/dist/index.min.js
// ../dist/index.js
export function amd(altUrl: string = "", min: boolean = true, additionalPaths: { [key: string]: string } = {}): Promise<any> {
    ...
    } else if (!altUrl && _loaderUrl.indexOf("file://") === 0) {
