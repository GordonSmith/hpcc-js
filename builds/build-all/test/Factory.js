...
(function (root, factory) {
    ...
    if (typeof define === "function" && define.amd) {
        define(["d3-collection", "require", "@hpcc-js/other", "./amchartFactory", "./c3chartFactory", "./chartFactory", "./compositeFactory", "./commonFactory", "./formFactory", "./googleFactory", "./graphFactory", "./layoutFactory", "./mapFactory", "./marshallerFactory", "./otherFactory", "./treeFactory", "./templatesFactory", "./handsonFactory", "./reactFactory"], factory);
    }
}(this, function (d3Collection, require, hpccOther, amchartFactory, c3chartFactory, chartFactory, compositeFactory, commonFactory, formFactory, googleFactory, graphFactory, layoutFactory, mapFactory, marshallerFactory, otherFactory, treeFactory, templatesFactory, handsonFactory, reactFactory) {
    var d3 = {
