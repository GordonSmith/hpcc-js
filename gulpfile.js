...
const libs = ["d3", "c3", "colorbrewer", "dagre", "topojson", "d3-cloud", "font-awesome", "amcharts", "es6-promise", "amcharts.funnel", "amcharts.gauge", "amcharts.pie", "amcharts.radar", "amcharts.serial", "amcharts.xy", "amcharts.gantt", "amcharts.plugins.responsive", "simpleheat", "d3-hexbin", "d3-tip", "d3-bullet", "d3-sankey", "autoComplete", "dgrid", "dstore"];
const bundles = ["common", "layout", "api", "other", "dgrid", "chart", "form", "c3chart", "google", "amchart", "tree", "graph", "map", "composite", "marshaller"];  //  Order is important ---
...
const amd_modules = bundles.map(function (bundle, idx) {
    ...
    switch (bundle) {
        case "common":
            include = ["d3", "d3-bullet", "d3-sankey", "d3-cloud", "es6-promise"].concat(include);
            break;
        case "dgrid":
            include = ["dgrid/util/touch", "dojo/selector/lite", "dgrid/extensions/nls/pagination"].concat(include);
            break;
    }
