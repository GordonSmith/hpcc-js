...
export default class XYAxis extends SVGWidget {
    ...
    columns(_) {
        return super.columns(...arguments);
    }
    ...
    calcMargin(domNode, element, isHorizontal) {
        var margin = {
    ...
    updateRegions(domNode, element, isHorizontal) {
        var context = this;
    ...
    updateChart(domNode, element, margin, width, height, isHorizontal, duration) {
    }
