...
(function (root, factory) {
    ...
    var createMap = function (gmapFlag, topoArr, opts, callback) {
        ...
        es6Require(["test/DataFactory", (gmapFlag ? "src/map/GMapLayered" : "src/map/Layered"),
            "src/map/OpenStreet", "src/map/ChoroplethContinents", "src/map/ChoroplethCountries", "src/map/ChoroplethStates", "src/map/TopoJSONChoropleth", "src/map/ChoroplethCounties",
            "src/map/Graticule", "src/map/GeoHash", "src/map/Graph", "src/map/Pins", "src/map/Heat"], function (DataFactory, Base, OpenStreet, ChoroplethContinents, ChoroplethCountries, ChoroplethStates, TopoJSONChoropleth, ChoroplethCounties,
                Graticule, GeoHash, Graph, Pins, Heat) {
                function Sample() {
                    Base.call(this);
    ...
    var mapFactory = {
        Graticule: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/Graticule"], function (DataFactory, Graticule) {
        ...
        ChoroplethCounties: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/ChoroplethCounties"], function (DataFactory, ChoroplethCounties) {
                    var rawData = DataFactory.Counties.simple.rawData;
                    var countyData = rawData.map(function (item) {
                        return [item.county, item.weight];
                    });
        ...
        ChoroplethCountries: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/ChoroplethCountries"], function (DataFactory, ChoroplethCountries) {
        ...
        ChoroplethContinents: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/ChoroplethContinents"], function (DataFactory, ChoroplethContinents) {
        ...
        ChoroplethStates: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/ChoroplethStates"], function (DataFactory, ChoroplethStates) {
            ...
            autoSizeData: function (callback) {
                es6Require(["src/map/ChoroplethStates"], function (ChoroplethStates) {
                    callback(new ChoroplethStates()
            ...
            pins: function (callback) {
                es6Require(["test/DataFactory", "src/map/ChoroplethStates", "src/map/Pins"], function (DataFactory, ChoroplethStates, Pins) {
                    var pins = new Pins()
                        .columns(DataFactory.GMap.simple.columns)
                        .data(DataFactory.GMap.simple.data)
                        ;
            ...
            heat: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Layered", "src/layout/AbsoluteSurface", "src/other/HeatMap"], function (DataFactory, Layered, AbsoluteSurface, HeatMap) {
        ...
        TopoJSONChoropleth: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/TopoJSONChoropleth"], function (DataFactory, TopoJSONChoropleth) {
        ...
        GMap: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/GMap"], function (DataFactory, GMap) {
                    callback(new GMap()
                        .columns(DataFactory.GMap.simple.columns)
                        .data(DataFactory.GMap.simple.data)
                    );
            ...
            splitStreetView: function (callback) {
                es6Require(["src/map/GMap", "src/layout/Grid"], function (GMap, Grid) {
                    var _map = new GMap()
            ...
            pins: function (callback) {
                es6Require(["test/DataFactory", "src/map/GMapPin"], function (DataFactory, GMapPin) {
            ...
            pinLines: function (callback) {
                es6Require(["test/DataFactory", "src/map/GMapPinLine"], function (DataFactory, GMapPinLine) {
            ...
            graph: function (callback) {
                es6Require(["test/DataFactory", "src/map/GMapGraph"], function (DataFactory, GMapGraph) {
            ...
            heat: function (callback) {
                es6Require(["test/DataFactory", "src/map/GMapHeat"], function (DataFactory, GMapHeat) {
        ...
        OpenStreet: {
            simple: function (callback) {
                es6Require(["src/map/OpenStreet"], function (OpenStreet) {
        ...
        GeoHash: {
            simple: function (callback) {
                es6Require(["src/map/GeoHash"], function (GeoHash) {
        ...
        Pins: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/Pins"], function (DataFactory, Pins) {
                    callback(new Pins()
                        .columns(DataFactory.GMap.simple.columns)
                        .data(DataFactory.GMap.simple.data)
                    );
        ...
        Lines: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/Lines"], function (DataFactory, Lines) {
                    callback(new Lines()
        ...
        Graph: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/Graph"], function (DataFactory, Graph) {
                    callback(new Graph()
                        .columns(DataFactory.GMap.simple.columns)
                        .data(DataFactory.GMap.simple.data)
                    );
        ...
        Heat: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/map/Heat"], function (DataFactory, Heat) {
                    callback(new Heat()
                        .columns(DataFactory.GMap.heat.columns)
                        .data(DataFactory.GMap.heat.data)
                    );
