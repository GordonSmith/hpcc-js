    ...
    return {
        Vertex: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "hpcc-js-viz/graph/Vertex"], function (DataFactory, Vertex) {
                    callback(new Vertex()
        ...
        Edge: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "hpcc-js-viz/graph/Graph", "src/common/Palette", "hpcc-js-viz/graph/Vertex", "hpcc-js-viz/graph/Edge"], function (DataFactory, Graph, Palette, Vertex, Edge) {
                    var graph = new Graph();
                    var vertices = [];
                    var edges = [];
        ...
        Sankey: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "hpcc-js-viz/graph/Sankey"], function (DataFactory, Sankey) {
