...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "require", "../src/other/Persist", "./amchartFactory", "./c3chartFactory", "./plotlyFactory", "./chartFactory", "./compositeFactory", "./commonFactory", "./formFactory", "./googleFactory", "./graphFactory", "./layoutFactory", "./mapFactory", "./marshallerFactory", "./otherFactory", "./treeFactory", "./templatesFactory", "./handsonFactory"], factory);
    } else {
        root.test_Factory = factory(root.d3, root.require, root.other_Persist, root.test_amchartFactory, root.test_c3chartFactory, root.test_plotlyFactory, root.test_chartFactory, root.test_compositeFactory, root.test_commonFactory, root.test_formFactory, root.test_googleFactory, root.test_graphFactory, root.test_layoutFactory, root.test_mapFactory, root.test_marshallerFactory, root.test_otherFactory, root.test_treeFactory, root.test_templatesFactory, root.test_handsonFactory);
    }
}(this, function (d3, require, Persist, amchartFactory, c3chartFactory, plotlyFactory, chartFactory, compositeFactory, commonFactory, formFactory, googleFactory, graphFactory, layoutFactory, mapFactory, marshallerFactory, otherFactory, treeFactory, templatesFactory, handsonFactory) {
    var bundles = { common: commonFactory, chart: chartFactory, amchart: amchartFactory, google: googleFactory, c3chart: c3chartFactory, plotly: plotlyFactory, composite: compositeFactory, map: mapFactory, tree: treeFactory, graph: graphFactory, other: otherFactory, form: formFactory, layout: layoutFactory, marshaller: marshallerFactory, templates: templatesFactory, handson: handsonFactory };
    var bundlesCatMap = {};
