...
(function (root, factory) {
    ...
    function Main() {
        var baseUrlXXX = "http://10.239.190.101:8002/WsEcl/forms/default/query/myroxie_dataland";
        this.connWeCare = new HPCCPlatformComms.JSONPTransport("http://10.241.100.159:8002/WsEcl/submit/query/roxie");
        ...
        this.googleMaps = new HPCCPlatformComms.XHRGetTransport("https://maps.googleapis.com/maps/api");
    ...
    Main.prototype.initSearch = function (id) {
        ...
        this.form = new Form()
            ...
            .on("clear", function (request) {
                ...
                var tmp = JSON.stringify(context.mainRequest);
                var newRequestXXX = {
                    bestfitmax: 10,
                ...
                context.connWeCare.send("wecares.serialoffenderfinderservice/json", context.mainRequest).then(function (response) {
                    var bestFit = response["wecares.serialoffenderfinderserviceResponse"].Results.BestFit.Row;
    ...
    var detailsCache = {};
    Main.prototype.fetchDetails = function (did) {
        if (detailsCache[did]) {
                ...
                if (selection.length) {
                    ...
                    if (row) {
                        ...
                        this.fetchDetails(row.__lparam.did).then(function (details) {
                            var addresses = details.map(function (addrRow) {
