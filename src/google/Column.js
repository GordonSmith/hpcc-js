...
(function (root, factory) {
    ...
    Column.prototype.publish("axisFontSize", null, "number", "X/Y Axis Label Font Size",null,{tags:['Basic']});
    Column.prototype.publish("axisFontFamily", null, "string", "X/Y Axis Label Font Name",null,{tags:['Basic']});
    
    Column.prototype.publish("xAxisFontColor", null, "html-color", "X Axis Text Font Color",null,{tags:['Basic']});
    Column.prototype.publish("yAxisFontColor", null, "html-color", "X Axis Text Font Color",null,{tags:['Basic']});
    ...
    Column.prototype.publish("xAxisTitle", "", "string", "X Axis Title",null,{tags:['Basic']});
    Column.prototype.publish("yAxisTitle", "", "string", "Y Axis Title",null,{tags:['Basic']});
    ...
    Column.prototype.publish("xAxisLabelRotation", 0, "number", "X Axis Label Angle",null,{tags:['Intermediate']});
