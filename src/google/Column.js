...
(function (root, factory) {
     ...
     */    
    Column.prototype.publish("isStacked", false, "boolean", "Stacks the elements in a series",null,{tags:['Advanced']});
    
    Column.prototype.publish("axisFontSize", null, "number", "Horizontal axis text style (Font Size)",null,{tags:['Basic']});
    Column.prototype.publish("axisFontFamily", null, "string", "Horizontal axis text style (Font Name)",null,{tags:['Basic']});

    Column.prototype.publish("xAxisFontColor", null, "html-color", "Horizontal axis text style (Color)",null,{tags:['Basic']});
    Column.prototype.publish("yAxisFontColor", null, "html-color", "Vertical axis text style (Color)",null,{tags:['Basic']});
    
    Column.prototype.publish("xAxisBaselineColor", "#000000", "html-color", "Specifies the color of the baseline for the horizontal axis",null,{tags:['Intermediate']});
    Column.prototype.publish("yAxisBaselineColor", "#000000", "html-color", "Specifies the color of the baseline for the vertical axis",null,{tags:['Intermediate']});
  
    Column.prototype.publish("xAxisTitle", "", "string", "Specifies a title for the horizontal axis",null,{tags:['Basic']});
    Column.prototype.publish("yAxisTitle", "", "string", "Specifies a title for the vertical axis",null,{tags:['Basic']});

    Column.prototype.publish("xAxisTitleFontColor", null, "html-color", "Horizontal axis title text style (Color)",null,{tags:['Intermediate']});
    Column.prototype.publish("yAxisTitleFontColor", null, "html-color", "Vertical axis title text style (Color)",null,{tags:['Intermediate']});
    
    Column.prototype.publish("xAxisTitleFontSize", null, "number", "Horizontal axis titletext style (Font Size)",null,{tags:['Intermediate']});
    Column.prototype.publish("yAxisTitleFontSize", null, "number", "Vertical axis titletext style (Font Size)",null,{tags:['Intermediate']});

    Column.prototype.publish("xAxisTitleFontFamily", null, "string", "Horizontal axis title text style (Font Name)",null,{tags:['Intermediate']});
    Column.prototype.publish("yAxisTitleFontFamily", null, "string", "Vertical axis title text style (Font Name)",null,{tags:['Intermediate']});
    ...
    Column.prototype.publish("xAxisBaseline", null, "number", "The baseline for the horizontal axis",null,{tags:['Intermediate']});
    Column.prototype.publish("yAxisBaseline", null, "number", "The baseline for the horizontal axis",null,{tags:['Intermediate']});
    ...
    Column.prototype.publish("xAxisFormat", "", "string", "A format string for numeric axis labels", ["","decimal","scientific","currency","percent","short","long"],{tags:['Intermediate']});
    Column.prototype.publish("yAxisFormat", "", "string", "A format string for numeric axis labels", ["","decimal","scientific","currency","percent","short","long"],{tags:['Intermediate']});
    ...
    Column.prototype.publish("yAxisGridlinesCount", 5, "number", "The number of vertical gridlines between two regular gridlines",null,{tags:['Intermediate']});
    
    Column.prototype.publish("xAxisGridlinesColor", "#CCC", "html-color", "The color of the horizontal gridlines inside the chart area",null,{tags:['Basic']});
    Column.prototype.publish("yAxisGridlinesColor", "#CCC", "html-color", "The color of the vertical gridlines inside the chart area",null,{tags:['Basic']});
    ...
    Column.prototype.publish("xAxisMinorGridlinesColor", "#FFFFFF", "html-color", "The color of the horizontal minor gridlines inside the chart area",null,{tags:['Intermediate']});
    ...
    Column.prototype.publish("yAxisMinorGridlinesColor", "#FFFFFF", "html-color", "The color of the vertical minor gridlines inside the chart area",null,{tags:['Intermediate']});
