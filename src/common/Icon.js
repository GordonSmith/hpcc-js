...
(function (root, factory) {
    ...
    Icon.prototype.publish("shape", "circle", "set", "Shape Type", ["circle", "square"],{tags:['Private','TODO2']});
    Icon.prototype.publishProxy("faChar", "_faChar", "char");
    Icon.prototype.publishProxy("image_color_fill", "_faChar", "color_fill");
    Icon.prototype.publish("tooltip", "", "string", "Tooltip",null,{tags:['Private','TODO2']});
    Icon.prototype.publish("diameter", 24, "number", "Diameter",null,{tags:['Private','TODO2']});
    Icon.prototype.publish("padding_percent", 45, "number", "Padding Percent",null,{tags:['Private','TODO2']});
