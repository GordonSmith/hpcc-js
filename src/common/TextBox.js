...
(function (root, factory) {
    ...
    TextBox.prototype.publish("paddingLeft", 4, "number", "Padding:  Left",null,{tags:['Private','TODO2']});
    TextBox.prototype.publish("paddingRight", 4, "number", "Padding:  Right",null,{tags:['Private','TODO2']});
    TextBox.prototype.publish("paddingTop", 4, "number", "Padding:  Top",null,{tags:['Private','TODO2']});
    TextBox.prototype.publish("paddingBottom", 4, "number", "Padding:  Bottom",null,{tags:['Private','TODO2']});
