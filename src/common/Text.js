...
(function (root, factory) {
    ...
    Text.prototype.publish("text", "", "string", "Display Text",null,{tags:['Private','TODO2']});
    Text.prototype.publish("fontFamily", "", "string", "Font Family",null,{tags:['Private','TODO2']});
    Text.prototype.publish("fontSize", null, "number", "Font Size (px)",null,{tags:['Private','TODO2']});
    Text.prototype.publish("anchor", "middle", "set", "Anchor Position", ["start", "middle", "end"],{tags:['Private','TODO2']});
    Text.prototype.publish("colorFill", null, "html-color", "Fill Color",null,{tags:['Private','TODO2']});
