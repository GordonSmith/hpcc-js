...
export class ResizeSurface extends Surface {
    ...
    static _class = "common_ResizeSurface";

    protected handleWidth = 8;
    protected handles = [{ loc: "NW" }, { loc: "N" }, { loc: "NE" }, { loc: "E" }, { loc: "SE" }, { loc: "S" }, { loc: "SW" }, { loc: "W" }];
    protected dispatch = d3.dispatch("sizestart", "size", "sizeend");
    protected drag;
    protected _domNode;
