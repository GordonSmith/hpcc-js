...
(function (root, factory) {
    ...
    Shape.prototype.publish("shape", "circle", "set", "Shape Type", ["circle", "square", "rect", "ellipse"],{tags:['Private','TODO2']});
    Shape.prototype.publish("width", 24, "number", "Width",null,{tags:['Private','TODO2']});
    Shape.prototype.publish("height", 24, "number", "Height",null,{tags:['Private','TODO2']});
    Shape.prototype.publish("colorStroke", null, "html-color", "Stroke Color", null);
    Shape.prototype.publish("colorFill", null, "html-color", "Fill Color", null);
