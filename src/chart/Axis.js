...
define(["require", "exports", "d3", "../common/SVGWidget", "css!./Axis"], function (require, exports, d3, SVGWidget) {
    ...
    var Axis = (function (_super) {
        ...
        Axis.prototype.type = function (_) {
            var retVal = this.type_call.apply(this, arguments);
            if (arguments.length) {
                this.updateScale();
            }
            return retVal;
        ...
        Axis.prototype.timePattern = function (_) {
            var retVal = this.timePattern_call.apply(this, arguments);
            if (arguments.length) {
                this.updateScale();
            }
            return retVal;
        ...
        Axis.prototype.wrap = function (text, bandSize, re) {
            ...
            var context = this;
            text.each(function () {
                var text = d3.select(this), words = text.text().split(re).reverse(), word, line = [], lineNumber = 0, lineHeight = 1.1, x = text.attr("x"), y = text.attr("y"), fs = parseFloat(text.style("font-size")) || 10, maxLinesPerBand = Math.floor(bandSize / (fs * lineHeight)) - 1, minWordsPerLine = context.isHorizontal() ? 1 : Math.ceil(words.length / maxLinesPerBand), dy = parseFloat(text.attr("dy"));
        ...
        Axis.prototype.postUpdate = function (domNode, element) {
            _super.prototype.postUpdate.apply(this, arguments);
            if (this._guideElement) {
                this._guideElement
