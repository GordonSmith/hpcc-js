...
define(["require", "exports", "d3", "../common/HTMLWidget", "../common/Utility", "../api/INDChart"], function (require, exports, d3, HTMLWidget_1, Utility_1, INDChart_1) {
    ...
    var MultiChart = (function (_super) {
        ...
        MultiChart.prototype.chart = function (_) {
            var retVal = this.chart_call.apply(this, arguments);
            if (arguments.length) {
                var context = this;
        ...
        MultiChart.prototype.render = function (callback) {
            if (this.chartType() && (!this.chart() || (this.chart().classID() !== this._allCharts[this.chartType()].widgetClass))) {
                ...
                this.switchChart(function () {
                    HTMLWidget_1.default.prototype.render.apply(context, args);
                });
                return this;
            }
    ...
    MultiChart.prototype.implements(INDChart_1.default.prototype);
    ...
    MultiChart.prototype._allChartTypes =
        MultiChart.prototype._1DChartTypes.concat(MultiChart.prototype._2DChartTypes.concat(MultiChart.prototype._NDChartTypes.concat(MultiChart.prototype._mapChartTypes.concat(MultiChart.prototype._anyChartTypes))));
