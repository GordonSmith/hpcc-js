...
(function (root, factory) {
    ...
    Table.prototype.applyRowStyles = function (row, isFirstCol) {
        ...
        row
            ...
            .style("background-color", isFirstCol ? this.tbodyFirstColBackgroundColor() : this.tableZebraColor_exists() && this.data().indexOf(dataRow) % 2 ? this.tbodyRowBackgroundColor() : this.tableZebraColor())
        ;
    };
