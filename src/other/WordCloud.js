...
(function (root, factory) {
    ...
    WordCloud.prototype.publish("padding", 1, "number", "Padding",null,{tags:['Intermediate','TODO2']});
    WordCloud.prototype.publish("fontFamily", "Verdana", "string", "Font Name",null,{tags:['Basic','TODO2']});
    WordCloud.prototype.publish("fontSizeFrom", 6, "number", "Font Size From",null,{tags:['Basic','TODO2']});
    WordCloud.prototype.publish("fontSizeTo", 24, "number", "Font Size To",null,{tags:['Basic','TODO2']});
    WordCloud.prototype.publish("angleFrom", -60, "number", "Angle From",null,{tags:['Basic','TODO2']});
    WordCloud.prototype.publish("angleTo", 60, "number", "Angle To",null,{tags:['Basic','TODO2']});
    WordCloud.prototype.publish("angleCount", 5, "number", "Angle Count",null,{tags:['Basic','TODO2']});
