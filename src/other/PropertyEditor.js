...
define(["require", "exports", "d3", "../common/HTMLWidget", "../other/Persist", "../layout/Grid", "../common/Widget", "css!./PropertyEditor"], function (require, exports, d3, HTMLWidget_1, Persist, Grid, Widget_1) {
    "use strict";
    ...
    PropertyEditor.prototype.widget = function (_) {
        if (arguments.length && this._widgetOrig() === _)
            return this;
