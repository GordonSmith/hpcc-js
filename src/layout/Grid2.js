...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "grid-list", "../common/HTMLWidget", "./Cell", "../common/TextBox", "../common/Utility", "css!./Grid2"], factory);
    } else {
    ...
    Grid2.prototype = Object.create(HTMLWidget.prototype);
    Grid2.prototype.constructor = Grid2;
    Grid2.prototype._class += " layout_Grid2";

    Grid2.prototype.publish("designMode", false, "boolean", "Design Mode", null, { tags: ["Basic"] });
    Grid2.prototype.publish("fitTo", "all", "set", "Sizing Strategy", ["all", "width"], { tags: ["Basic"] });
    Grid2.prototype.publish("snapping", "vertical", "set", "Snapping Strategy", ["vertical", "horizontal"]);
    Grid2.prototype.publish("snappingLanes", 12, "number", "Snapping Lanes");

    Grid2.prototype.publish("gutter", 4, "number", "Gap Between Widgets", null, { tags: ["Basic"] });
    Grid2.prototype.publish("surfacePadding", null, "string", "Cell Padding (px)", null, { tags: ["Intermediate"] });

    Grid2.prototype.publish("content", [], "widgetArray", "widgets",null,{tags:["Basic"]});

    Grid2.prototype.getDimensions = function () {
    ...
    Grid2.prototype.clearContent = function (widget) {
    ...
    Grid2.prototype.setContent = function (row, col, widget, title, rowSpan, colSpan) {
        rowSpan = rowSpan || 1;
        colSpan = colSpan || 1;
        title = title || "";
        this.content(this.content().filter(function (contentWidget) {
    ...
    Grid2.prototype.sortedContent = function () {
    ...
    Grid2.prototype.getCell = function (row, col) {
        var retVal = null;
    ...
    Grid2.prototype.getWidgetCell = function (id) {
        var retVal = null;
        this.content().some(function (cell) {
    ...
    Grid2.prototype.getContent = function (id) {
        var retVal = null;
        this.content().some(function (cell) {
            if (cell.widget()._id === id) {
                retVal = cell.widget();
    ...
    Grid2.prototype.cellToGridItem = function(cell) {
        return {
            x: cell.gridCol(),
            y: cell.gridRow(),
            w: cell.gridColSpan(),
    ...
    Grid2.prototype.gridItemToCell = function (item) {
        item.cell
            .gridCol(item.x)
            .gridRow(item.y)
            .gridColSpan(item.w)
    ...
    Grid2.prototype.initGridList = function () {
        this.itemsMap = {};
    ...
    Grid2.prototype.killGridList = function () {
        this.gridList = null;
        delete this.items;
        delete this.itemsMap;
    };

    Grid2.prototype.enter = function (domNode, element) {
    ...
    Grid2.prototype.updateGrid = function (resize, transitionDuration) {
        transitionDuration = transitionDuration || 0;
        var context = this;
        this.divItems
            .classed("draggable", this.designMode())
            .classed("selected", function (d) { return d === context.selectedWidget; })
            ...
            .each("end", function (d) {
                d.surfacePadding_default(context.surfacePadding());
    ...
    Grid2.prototype.update = function (domNode, element) {
        ...
        //  Grid  ---
        var context = this;
        this.divItems = element.selectAll(".ddCell").data(this.content(), function (d) { return d.id(); });
        var enterDiv = this.divItems.enter().append("div")
            .attr("class", "ddCell")
            .call(this._d3Drag)
            .each(function (d) {
                d.target(this);
        ...
        //  Snapping  ---
        var lanesBackground = element.selectAll(".laneBackground").data(this.designMode() ? [""] : []);
        ...
        var lanes = element.selectAll(".lane").data(this.designMode() ? [""] : []);
    ...
    Grid2.prototype.exit = function (domNode, element) {
        HTMLWidget.prototype.exit.apply(this, arguments);
    };

    Grid2.prototype._createSelectionObject = function (d) {
        return {
            _id: d._id,
            element: function () {
                return d._element;
    ...
    Grid2.prototype.selection = function (_) {
    ...
    Grid2.prototype.selectionBagClear = function () {
    ...
    Grid2.prototype.selectionBagClick = function (d) {
        if (d !== null) {
    ...
    Grid2.prototype.postSelectionChange = function () {
    };
