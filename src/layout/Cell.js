...
(function (root, factory) {
    ...
    Cell.prototype.publish("gridRow", 0, "number", "Grid Row Position",null,{tags:['Private','TODO2']});
    Cell.prototype.publish("gridCol", 0, "number", "Grid Column Position",null,{tags:['Private','TODO2']});
    Cell.prototype.publish("gridRowSpan", 1, "number", "Grid Row Span",null,{tags:['Private','TODO2']});
    Cell.prototype.publish("gridColSpan", 1, "number", "Grid Column Span",null,{tags:['Private','TODO2']});
    Cell.prototype.publish("handleSize", 6, "number", "Grid Row Position",null,{tags:['Private','TODO2']});
