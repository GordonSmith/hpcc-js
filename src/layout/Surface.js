...
(function (root, factory) {
    ...
    Surface.prototype.publish("padding", null, "number", "Surface Padding (px)",null,{tags:['Intermediate','TODO2']});
    
    Surface.prototype.publish("titlePadding", null, "number", "Title Padding (px)",null,{tags:['Intermediate','TODO2']});
    Surface.prototype.publish("titleFontSize", null, "string", "Title Font Size",null,{tags:['Basic','TODO2']});
    Surface.prototype.publish("titleFontColor", null, "html-color", "Title Font Color",null,{tags:['Basic','TODO2']});
    Surface.prototype.publish("titleFontFamily", null, "string", "Title Font Family",null,{tags:['Basic','TODO2']});
    Surface.prototype.publish("titleFontBold", true, "boolean", "Enable Bold Title Font",null,{tags:['Intermediate','TODO2']});
    Surface.prototype.publish("titleBackgroundColor", null, "html-color", "Title Background Color",null,{tags:['Basic','TODO2']});
    
    Surface.prototype.publish("backgroundColor", null, "html-color", "Surface Background Color",null,{tags:['Basic','TODO2']});
    
    Surface.prototype.publish("borderWidth", null, "string", "Surface Border Width",null,{tags:['Basic','TODO2']});
    Surface.prototype.publish("borderColor", null, "html-color", "Surface Border Color",null,{tags:['Basic','TODO2']});
    Surface.prototype.publish("borderRadius", null, "string", "Surface Border Radius",null,{tags:['Basic','TODO2']});
    
    Surface.prototype.publish("title", "", "string", "Title",null,{tags:['Intermediate','TODO2']});
    Surface.prototype.publish("titleAlignment", "center", "set", "Title Alignment", ["left","right","center"],{tags:['Intermediate','TODO2']});
    Surface.prototype.publish("widget", null, "widget", "Widget",null,{tags:['Advanced','TODO2']});
